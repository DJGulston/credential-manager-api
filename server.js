...
// Sets the port number on which the app will listen.
const PORT = process.env.PORT || 8080;

// Connects the server to the MongoDB database.
connectDB();

// Allows JSON data to be passed through the body of
// HTTP requests.
app.use(bodyParser.urlencoded({extended: false}));
app.use(bodyParser.json());

// Improves security of our Express app by setting
// certain headers.
...
// Allows the Express app to access all the user associated routes.
app.use('/', usersRouter);

// Configures the Express app to listen on our dseginated port number.
app.listen(PORT, () => {
