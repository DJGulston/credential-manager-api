...
/**
 * MongoDB Schema for the Organisational Unit document
 * in the Credentials database.
 */
const organisationalUnitSchema = mongoose.Schema({
    name: {
        type: String,
        required: true
    },
...
module.exports = mongoose.model('OrganisationalUnit', organisationalUnitSchema, 'organisationalUnits');
